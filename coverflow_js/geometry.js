		...
		if( $.coverflow.support.transform ) {
			switch( state ) {
				case 'left':
					...
					equal( $item.hasClass( 'ui-state-active' ), false, 'item without ui-state-active coverflow_css class' );
					break;
				case 'right':
					strictEqual(
							cssTransformation,
				...
				default:
					...
					equal( $item.hasClass( 'ui-state-active' ), true, 'item has ui-state-active coverflow_css class' );
			}
		}
