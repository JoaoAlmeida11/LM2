...
/*
 * Detect support for 3d coverflow_css transformations
 ...
 *
 * Depends:
 *  jquery.ui.core.coverflow_js
 *  jquery.ui.widget.coverflow_js
 *
 * In case you want swipe support and you don't use jQuery mobile yet:
 * jquery-mobile.custom.coverflow_js
 *
 * $.animate support for older browsers depends on:
 *  jquery.ui.effect.coverflow_js
 *
 * Events:
 *  beforeselect
 *  select
 */
	...
	$.coverflow = $.extend( true, {}, $.coverflow, {
		...
		transition : {
			 ...
			 *
			 * easing not available as coverflow_css timing functions:
			 *
			 * easeInElastic
			 * easeOutElastic
			 * easeInOutElastic
